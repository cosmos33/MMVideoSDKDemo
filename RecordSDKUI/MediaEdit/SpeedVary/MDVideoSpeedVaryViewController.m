...
@property (nonatomic, strong) MDRecordVideoNewSpeedSlider *sliderView;
...
- (MDRecordVideoNewSpeedSlider *)sliderView {
    if (!_sliderView) {
        _sliderView = [[MDRecordVideoNewSpeedSlider alloc] initWithFrame:CGRectMake(0, MDScreenHeight - 180 - HOME_INDICATOR_HEIGHT, MDScreenWidth - 60, 83)];
        _sliderView.centerX = self.view.centerX;
        __weak typeof(self) weakself = self;
        _sliderView.valueChanged = ^(MDRecordVideoNewSpeedSlider *slider, CGFloat value) {
