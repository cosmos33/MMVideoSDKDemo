...
<
    MDRecordNewMediaEditorBottomViewDelegate
>
...
// 底部按钮
@property (nonatomic, strong) MDRecordNewMediaEditorBottomView *buttonView;
...
- (MDRecordNewMediaEditorBottomView *)buttonView {
    if (!_buttonView) {
        ...
        _buttonView = [[MDRecordNewMediaEditorBottomView alloc] initWithFrame:CGRectZero titles:titles imageNames:imageNames];
...
#pragma mark - MDRecordNewMediaEditorBottomViewDelegate methods
