...
//        _faceDecorationButton = [UIButton buttonWithType:UIButtonTypeCustom];
//        _faceDecorationButton.translatesAutoresizingMaskIntoConstraints = NO;
//        _faceDecorationButton.adjustsImageWhenHighlighted = NO;
//        [_faceDecorationButton setImage:[UIImage imageNamed:@"changeFace"] forState:UIControlStateNormal];
//        [_faceDecorationButton addTarget:self action:@selector(clickFaceDecorationAction:) forControlEvents:UIControlEventTouchUpInside];
//        [_faceDecorationButton setTitle:@"特效" forState:UIControlStateNormal];
//        _faceDecorationButton.titleLabel.font = [UIFont systemFontOfSize:11];
