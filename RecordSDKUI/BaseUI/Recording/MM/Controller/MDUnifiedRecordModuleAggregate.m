...
- (void)clickWithVC:(MDMomentMakeUpViewController *)vc index:(NSInteger)index {
    switch (index) {
        case 1:
            [self.recordHandler addMakeupEffectWithItem:[[MDMomentMakeupDailyItem alloc] init]];
            break;
        case 2:
            [self.recordHandler addMakeupEffectWithItem:[[MDMomentMakeupClearwaterItem alloc] init]];
            break;
        case 3:
            [self.recordHandler addMakeupEffectWithItem:[[MDMomentMakeupFreckleItem alloc] init]];
            break;
        case 4:
            [self.recordHandler addMakeupEffectWithItem:[[MDMomentMakeupTantanItem alloc] init]];
            break;
