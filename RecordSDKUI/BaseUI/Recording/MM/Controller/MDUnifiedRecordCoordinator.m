...
//    BOOL hasShowFilterGuide = YES; //[[[MDContext currentUser] dbStateHoldProvider] hasShowFilterGuide];
    //首次引导
//    if (!hasShowFilterGuide) {
//        self.containerView.slidingFilterView.currentPageIndex = 0;
        //切到自然滤镜
//        __weak typeof(self) weakSelf = self;
//        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.0f * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
//            [weakSelf.containerView.slidingFilterView setCurrentPageIndex:[[[MDContext currentUser] dbStateHoldProvider] recordFilterInedx] animated:YES];
//        });
//        [[[MDContext currentUser] dbStateHoldProvider] setHasShowFilterGuide:YES];
        
//    } else {
        //没有记录使用默认滤镜,有记录使用记录滤镜
        self.containerView.slidingFilterView.currentPageIndex = 0; //[[[MDContext currentUser] dbStateHoldProvider] recordFilterInedx];
//    }
}
